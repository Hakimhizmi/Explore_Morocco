...
export default function Home() {
  ...
  <div className="absolute bottom-10">
    ...
    <a href="#" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center h-8 w-8 border border-gray-100 text-gray-100  rounded-full mr-1 hover:text-red-500 hover:border-red-500">
