...
export default function Home() {
  ...
  return (
    <section className="flex items-center justify-center relative w-screen h-screen overflow-hidden">
      ...
      <div className="absolute hidden md:block top-3 right-10 saturate-50 mx-auto" id="box" />
      <main className="grid w-full place-items-center ">
        ...
        <div className="absolute scale-125 left-1/2 top-1/2 h-96 w-80 -translate-x-1/2 -translate-y-1/2 md:rotate-6 space-y-6 rounded-2xl bg-gray-100 p-6 transition duration-300 hover:rotate-0">
      ...
      <div className="absolute bottom-10">
        ...
        <a href="https://twitter.com/?lang=en" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center h-8 w-8 border border-gray-100 text-gray-100  rounded-full mr-1 hover:text-red-500 hover:border-red-500">
